...
<br>
	<div class="container col-md-8 col-md-offset-2">
		...
		<div class="panel panel-primary">
			<div class="panel-heading text-center"><h2>Update Product</h2></div>
			<div class="panel-body">
				
				<form:form action="${pageContext.request.contextPath}/update" method="POST" modelAttribute="prod">
				  
				  <div class="form-group">
				    <label for="id">ID : </label>
				    <input type="text" class="form-control" id="id" name="id" value="${produit.id}" readonly="readonly">
				  </div>
				  
				  <div class="form-group">
				    <label for="designation">Désignation : </label>
				    <form:errors path="designation" cssClass="error text-danger" />
				    <input type="text" class="form-control" id="designation" name="designation" value="${produit.designation}" required="required">
				  </div>
				  ...
				  <button type="submit" class="btn btn-default">Update</button>
				  	...
				  	<a type="submit" class="btn btn-default" href="${pageContext.request.contextPath}/">Cancel</a>
